/*============================================================================
Filename : qtm_acq_avr_da_0x0037_api.h
Project : QTouch Modular Library
Purpose : API for Acquisition module - AVR-DA/PTC
------------------------------------------------------------------------------
Copyright (c) 2020- Microchip Inc. All rights reserved.
------------------------------------------------------------------------------
============================================================================*/

#ifndef TOUCH_API_AVR_DA_ACQ_MODULE_H
#define TOUCH_API_AVR_DA_ACQ_MODULE_H
...
#define QTML_PTC_vect_num  27
#define QTML_PTC_vect _VECTOR(27)  /*  */
...
#define PRSC_MAX_OPTION                 PRSC_DIV_SEL_16
...
typedef enum tag_pit_div_t
{
	...
	NODE_SCAN_512MS  = 8u,
	NODE_SCAN_1024MS = 9u,
	NODE_SCAN_2048MS = 10u,
	NODE_SCAN_4096MS = 11u,
	NODE_SCAN_8192MS = 12u
}
pit_div_t;
...
typedef struct
{
  ...
  qtm_acq_avr_da_node_config_t* qtm_acq_node_config;
...
/*============================================================================
uint16_t avr_da_acq_module_get_id(void);
------------------------------------------------------------------------------
...
Notes  : none
============================================================================*/
uint16_t qtm_avr_da_acq_module_get_id(void);



/*============================================================================
uint8_t avr_da_acq_module_get_version(void);
------------------------------------------------------------------------------
...
Notes  : none
============================================================================*/
uint8_t qtm_avr_da_acq_module_get_version(void);
...
/*============================================================================
void qtm_avr_da_ptc_handler_wcomp(void)
------------------------------------------------------------------------------
...
#endif /* TOUCH_API_AVR_DA_ACQ_MODULE_H*/
