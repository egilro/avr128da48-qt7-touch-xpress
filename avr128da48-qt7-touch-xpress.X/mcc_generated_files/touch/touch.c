...
/* Node configurations */
qtm_acq_avr_da_node_config_t ptc_seq_node_cfg1[DEF_NUM_CHANNELS] = { NODE_0_PARAMS, NODE_1_PARAMS, NODE_2_PARAMS, NODE_3_PARAMS,NODE_4_PARAMS};
...
{
    RTC_WritePeroid(32);
	RTC_SetCMPIsrCallback(touch_timer_handler);
